...
DTYPE_X = np.int8
ctypedef cnp.int8_t DTYPE_X_t

DTYPE_W = np.int8
ctypedef cnp.int8_t DTYPE_W_t
...
def conv1d_opt_x_int8_w_b1(cnp.ndarray[DTYPE_X_t, ndim=2] x, cnp.ndarray[DTYPE_W_t, ndim=3] w, unsigned int dilation):
